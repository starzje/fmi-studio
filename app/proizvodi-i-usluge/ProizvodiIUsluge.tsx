...
export default function ProizvodiIUslugePage() {
  ...
  // Filter components based on the category
  const renderCards = () => {
    switch (category) {
      case "promotivni-materijali":
        return (
          <div className="mt-8">
            <h2 className="text-xl leading-snug text-gray-800  font-bold mb-5">Promotivni Materijali</h2>
      ...
      case "tiskani-materijali":
        return (
          <div className="mt-8">
            <h2 className="text-xl leading-snug text-gray-800  font-bold mb-5">Tiskani Materijali</h2>
            <div className="grid grid-cols-12 gap-6">
              <ShopCards02 />
            </div>
          </div>
      ...
      case "reklamne-povrsine":
        return (
          <div className="mt-8">
            <h2 className="text-xl leading-snug text-gray-800  font-bold mb-5">Reklamne Površine i Oprema</h2>
            <div className="grid grid-cols-12 gap-6">
              <ShopCards03 />
            </div>
          </div>
      ...
      case "naljepnice-i-grafika":
        return (
          <div className="mt-8">
            <h2 className="text-xl leading-snug text-gray-800  font-bold mb-5">Naljepnice i Grafika</h2>
            <div className="grid grid-cols-12 gap-6">
              <ShopCards04 />
            </div>
          </div>
