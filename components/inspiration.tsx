          ...
          <div>
            ...
            <div className="mb-8">
              <div className="flex flex-wrap justify-center md:justify-start -m-1.5">
                ...
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${
                    category === "3" ? "bg-blue-100 border-blue-300" : "bg-white border-gray-200"
                  }`}
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <span
                      className={`text-xs font-semibold px-1 py-px rounded-full ml-2 ${
                        category === "3" ? "text-white bg-blue-300" : "text-gray-400 bg-gray-100"
                      }`}>
                      1.7K
                    </span>
                  </div>
                ...
                <button
                  className={`relative font-medium text-gray-800 text-sm pl-3 pr-1.5 py-1.5 border rounded-full inline-flex m-1.5 ${
                    category === "4" ? "bg-blue-100 border-blue-300" : "bg-white border-gray-200"
                  }`}
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <span
                      className={`text-xs font-semibold px-1 py-px rounded-full ml-2 ${
                        category === "4" ? "text-white bg-blue-300" : "text-gray-400 bg-gray-100"
                      }`}>
                      989
                    </span>
                  </div>
            ...
            <div className="relative">
              ...
              <div
                ...
                <a
                  ...
                  style={!["0", "1", "3"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "2", "3"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="100">
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "1", "3", "4"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="200">
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "1", "2", "4"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="300">
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "1", "2"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="400">
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "1", "2", "3", "4"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="500">
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "2", "3", "4"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="700">
                ...
                <a
                  className="relative group hover:shadow-xl transition duration-150 ease-in-out"
                  style={!["0", "2", "4"].includes(category) ? { display: "none" } : {}}
                  href="#0"
                  data-aos="fade-down"
                  data-aos-anchor="[data-aos-id-inpspiration]"
                  data-aos-delay="800">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-[352px] bg-gradient-to-t from-white to-transparent">
                <div className="flex h-full items-end justify-center">
                  <Link
                    className="btn rounded-lg text-white bg-blue-500 hover:bg-blue-600 shadow-sm mb-6"
                    href="/signup">
                    Join The Community
                  </Link>
                </div>
